define(function(require, exports, module) {
	...
	test("jQuery()", function() {
		...
		var elem, i, obj = jQuery("div"), main = jQuery("#qunit-fixture"), code = jQuery("<code/>"), img = jQuery("<img/>"), div = jQuery("<div/><hr/><code/><b/>"), exec = false, lng = "", expected = 26, attrObj = {
			"click" : function() {
	...
	test("isNumeric", function() {
		...
		var t = jQuery.isNumeric, Traditionalists = /** @constructor */
		function(n) {
			this.value = n;
			this.toString = function() {
				return String(this.value);
			};
		}, answer = new Traditionalists("42"), rong = new Traditionalists("Devo");
	...
	test("map()", function() {
		...
		flat = jQuery.map(Array(4), function(v, k) {
			return k % 2 ? k : [k, k, k];
			//try mixing array and regular returns
		});
	...
	test("jQuery.makeArray", function() {
		...
		// For #5610
		deepEqual(jQuery.makeArray({
			length : "0"
		}), [], "Make sure object is coerced properly.");
		deepEqual(jQuery.makeArray({
			length : "5"
		}), [], "Make sure object is coerced properly.");
	});
	...
	test("jQuery.isEmptyObject", function() {
		...
		equal(false, jQuery.isEmptyObject({
			a : 1
	...
	test("jQuery.parseJSON", function() {
		...
		deepEqual(jQuery.parseJSON("{\"test\":1}"), {
			"test" : 1
		}, "Plain object parses");
	...
	if (jQuery.sub_runs_too_slow_in_IE6) {
		...
		test("jQuery.sub() - Static Methods", function() {
			...
			SubSubclass.fn.extend({
				"subSubClassMethod" : function() {
					return this;
				}
			});
			SubSubclass["setup"]({
